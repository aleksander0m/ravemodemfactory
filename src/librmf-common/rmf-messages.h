...
enum {
    ...
    RMF_RESPONSE_STATUS_ERROR_INTERFACE_NOT_FOUND              = 143,
    RMF_RESPONSE_STATUS_ERROR_FLOW_SUSPENDED                   = 144,
    RMF_RESPONSE_STATUS_ERROR_INVALID_DATA_FORMAT              = 145,
    ...
    RMF_RESPONSE_STATUS_ERROR_NOT_MCAST_INTERFACE              = 161,
    RMF_RESPONSE_STATUS_ERROR_MAXIMUM_MCAST_REQUESTS_IN_USE    = 162,
    RMF_RESPONSE_STATUS_ERROR_INVALID_MCAST_HANDLE             = 163,
    RMF_RESPONSE_STATUS_ERROR_INVALID_IP_FAMILY_PREFERENCE     = 164,
    ...
    RMF_RESPONSE_STATUS_ERROR_PARTIAL_FAILURE                  = 178,
    RMF_RESPONSE_STATUS_ERROR_POLICY_MISMATCH                  = 179,
    ...
    RMF_RESPONSE_STATUS_ERROR_PB_DELETE_IN_PROGRESS            = 209,
    RMF_RESPONSE_STATUS_ERROR_PB_TEXT_TOO_LONG                 = 210,
    RMF_RESPONSE_STATUS_ERROR_PB_NUMBER_TOO_LONG               = 211,
    RMF_RESPONSE_STATUS_ERROR_PB_HIDDEN_KEY_RESTRICTION        = 212,
    RMF_RESPONSE_STATUS_ERROR_PB_NOT_AVAILABLE                 = 213,
    RMF_RESPONSE_STATUS_ERROR_DEVICE_MEMORY_ERROR              = 214,
    RMF_RESPONSE_STATUS_ERROR_NO_PERMISSION                    = 215,
    RMF_RESPONSE_STATUS_ERROR_TOO_SOON                         = 216,
    RMF_RESPONSE_STATUS_ERROR_TIME_NOT_ACQUIRED                = 217,
    RMF_RESPONSE_STATUS_ERROR_OPERATION_IN_PROGRESS            = 218,
    /* NOTE: update rmfd_error_message_new_from_error() if the last element is increased */
};
...
typedef enum  {
    ...
    RMF_REGISTRATION_STATUS_SCANNING,
